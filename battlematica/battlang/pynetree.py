# all credit for this code goes to Jan Max Meyer.
# pynetree was not integrated as a dependency due to an import problem
# in the packaged version, to my knowledge no longer maintained as of
# jan 20.
